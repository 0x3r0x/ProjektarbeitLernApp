...
namespace ProjektarbeitLernApp.Service
{
    ...
    public class StatisticService
    {
        ...
        {
            return dbContext.Statistic.Count(e => e.User_Id.Equals(user.Id) && e.WasKnown.Equals(true));
        }
        ...
        {
            return dbContext.Statistic.Count(e => e.User_Id.Equals(user.Id) && e.WasKnown.Equals(false));
        }
        ...
        {
            var res = dbContext.Statistic.Where(e => e.User_Id.Equals(user.Id)).GroupBy(e => e.DateTime.Date).Select(g => (double)g.Count()).ToArray();
            return res;
        }
        ...
        {
            var res = dbContext.Statistic.Where(e => e.User_Id.Equals(user.Id)).Select(e => e.DateTime.Date).Distinct().Select(e => e.ToString("dd.MM.")).ToArray();
            return res;
        }
